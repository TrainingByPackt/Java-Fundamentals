...
public class BinarySearchTree {
   ...
   * (again recursively check if it has child nodes and the
   *
   * @param root
   * @param newNode
   */
  ...
  /**
   * As per BST, the right most node will be highest of the all. iterate all the
   * right nodes until we reach empty right and get the value of it root.
   *
