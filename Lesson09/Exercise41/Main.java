...
throw new IllegalArgumentException("An empty string was
given instead of a digit");
}
...
System.out.println("An illegal argument was provided: " +
e.getMessage());
}
}
}